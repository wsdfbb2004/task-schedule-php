...
class Connection
{
    ...
    private $_socketTimeoutSec;
    private $_socketTimeoutMsec;

    /**
     * @param string $hostname
     * @param int    $port
     * @param float  $connectTimeout
     * @param int    $socketTimeoutSec
     * @param int    $socketTimeoutMsec
     */
    public function __construct($hostname, $port, $connectTimeout = null, $socketTimeoutSec = 1, $socketTimeoutMsec = 0)
    {
        ...
        $this->_socketTimeoutMsec = $socketTimeoutMsec;
    }
    ...
    private function _getSocket()
    {
        if (!isset($this->_socket)) {
            $this->_socket = new NativeSocket(
                ...
                $this->_socketTimeoutSec,
                $this->_socketTimeoutMsec
            );
        }
